...
import idea.irpc.framework.core.dispatcher.ServerChannelDispatcher;
...
public class CommonServerCache {
    ...
    public static ServerChannelDispatcher SERVER_CHANNEL_DISPATCH = new ServerChannelDispatcher();
}
